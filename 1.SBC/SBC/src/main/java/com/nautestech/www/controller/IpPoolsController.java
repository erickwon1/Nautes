...
public class IpPoolsController {
	...
	public String ipPoolsAdd(Pageable pageable, @ModelAttribute IpPools ipPool, Model model) {
	...
	@ResponseBody
	public int deleteIpPools(@RequestBody Map<String, List<String>> requestData) {
	...
	@ResponseBody
	public void modifyIpPools(@RequestBody Map<String, Object> requestData) {
